...
test("uses protected Next.js routes and Google Sheets without database bindings", async () => {
  const [packageJson, page, layout, proxy, manifest, pwaRegister, stateRoute, historyRoute, wishlistRoute, loginRoute, lifePlan, lifePlanPanel, sheets] = await Promise.all([
